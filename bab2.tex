...
\par Keterangan:
\par Xi = data ke-i
\par W = niai bobot support vector yang tegak lurus dengan \par hyperplane
\par b = niai bias
\par Yi = kelas data ke-i

\par Bobot vector (w) adalah garis vektor yang tegak lurus antara titik pusat kordinat dengan garis hyperplane. Bias (b) merupakan kordinat garis relative terhadap titik kordinat.
