...
\begin{enumerate}[a.]
	...
	\item Antar Muka Aplikasi LocaLization
	      ...
	      % 	      \caption{Halaman Hasil Prediksi untuk Lantai 3}
	      %       \end{subfigure}
	      %       \begin{subfigure}{.5\textwidth}
	      % 	      \centering
	      % 	      % include second image
	      % 	      \includegraphics[width=.5\linewidth]{gambar/lantai 4 (1).png}
	      % 	      \caption{{Halaman Hasil Prediksi untuk Lantai 1}
	      %       \end{subfigure}
	      %       \vspace{1cm}
	      %       \newline
	      %       \begin{center}
	      ...
	      % 		      \caption{Halaman Detail Estimasi Tiap Lokasi di dalam Gedung}
	      % 	      \end{subfigure}
	      %       \end{center}
	      %       \vspace{0.5cm}
	...
	\item Antar Muka Aplikasi Web Monitoring
	      ...
	      %   \begin{figure}[H]
	      %       \center
	      %       \includegraphics [width = 9 cm, height= 4.5 cm]{gambar/web/Login}
	      %       \caption{Halaman \textit{login}Web Monitoring}
	      %       \label{LoginWeb}
	      %   \end{figure}
	      %   \begin{figure}[H]
	      %       \center
	      %       \includegraphics [width = 9 cm, height= 4.5 cm]{gambar/web/Dashbord}
	      %       \caption{Halaman \textit{dashbord}}
	      %       \label{Dashbord}
	      %   \end{figure}
	      %   \begin{figure}[H]
	      %       \center
	      %       \includegraphics [width = 9 cm, height= 4.5 cm]{gambar/web/Estimasi_Grafik}
	      %       \caption{Halaman Estimasi Orang Tiap Posisi dalam Bentuk Grafik}
	      %       \label{Estimasi_Grafik}
	      %   \end{figure}
	      %   \begin{figure}[H]
	      %       \center
	      %       \includegraphics [width = 9 cm, height= 4.5 cm]{gambar/web/Estimasi_Tabel}
