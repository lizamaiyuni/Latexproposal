...
\judulinggris{\MakeUppercase{\textit{Developing Application for estimating the location and the number of people in the building based on Crowdsourcing Indoor localization system using the Support vector machine (SVM) algorithm}}}
