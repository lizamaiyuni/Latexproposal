...
\begin{figure}[H]
	\centering
	\subfloat[Denah Lantai 1]{{\includegraphics[width=13cm, height=7cm]{gambar/class1.png} }}%
	\qquad
	\subfloat[Denah Lantai 2]{{\includegraphics[width=13cm, height=8cm]{gambar/class2.png} }}

	\centering
	\subfloat[Denah Lantai 3]{{\includegraphics[width=12cm, height=6cm]{gambar/class3.png} }}
